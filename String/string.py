...
#                  and format value store in the {} -> (curly brackets) here line no. 69 in {>10} means right side of given new string                  range in 10 and {<10} means left side of given new string range in 10 and {^10} means middle part of given new                       stringrange in 10
